...
## Week 3: 편집/공유/다이어그램
- [ ] 전사 텍스트 뷰어 + 키워드 검색/편집 기능.
- [ ] 요약 및 Action Item 편집 UI(인라인 편집/검증) 완성.
- [ ] `/api/diagram`: Mermaid/Chart.js 데이터 생성 및 렌더링(초기에는 클라이언트 렌더 허용) 후 Supabase Storage에 저장.
- [ ] 공유 링크 생성/관리: 토큰 기반 읽기 전용 페이지, 만료 기간 설정.
